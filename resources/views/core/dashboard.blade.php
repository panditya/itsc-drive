            ...
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="orange">
                        ...
                        <a href="{{route('category.create')}}" class="pull-right" data-toggle="modal" data-target="#addCategoriesModal">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        ...
                        <a href="{{route('file.create')}}" class="pull-right" data-toggle="modal" data-target="#addFilesModal">
                          <h4><i class="fa fa-plus"></i></h4>
                        </a>
